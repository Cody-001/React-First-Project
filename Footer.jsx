                  ...
                  <div className="single-footer-caption mb-50">
                    ...
                    <div className="footer-tittle">
                      ...
                      <ul>
                        ...
                        <li><a href="#"><span className="__cf_email__" data-cfemail="c7a4a8a9b3a6a4b387a4a6aca2b4afa8b7e9a4a8aa">[email&#160;protected]</span></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                  <div className="singleLeft single-footer-caption mb-50">
                    ...
                    <div className="footer-tittle">
                      ...
                      <ul>
                        <li><a href="#">913-473-7000</a></li>
                        <li><a href="#"><span className="__cf_email__" data-cfemail="21424e4f554042556142404a4452494e510f424e4c">[email&#160;protected]</span></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
